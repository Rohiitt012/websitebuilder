...
export default function SignUpForm() {
  ...
  const [loading, setLoading] = useState<"google" | "facebook" | "credentials" | null>(null);
        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Sign up with Google/Facebook – your data is saved in PostgreSQL.
            </p>
          </div>
          <div>
            {error && (
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              ...
              >
                ...
                {loading === "facebook" ? "Signing up…" : "Sign up with Facebook"}
              </button>
            </div>
            ...
            >
              <div className="space-y-5">
                ...
                <div>
                  ...
                  >
                    {loading === "credentials" ? "Signing up…" : "Sign Up"}
                  </button>
                </div>
              </div>
            </form>
